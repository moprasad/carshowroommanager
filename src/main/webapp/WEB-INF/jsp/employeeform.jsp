...
<td valign="top">
   <table border="0" width="765" height="675" cellspacing="0" cellpadding="0" bgcolor="#859563">
   <tr>
   <td valign="top">
   <form method="post" action="/employeeupdate"><table border="0" width="600"  cellspacing="0" cellpadding="2" align="center">
<tr>
<td align="center" colspan="2"><br><br><br><font face="forte" size="5" color="red"><b>EMPLOYEE DETAIL</font>
</td>
</tr>
<tr>
<td colspan="2"><hr width="90%" align="center" size="5" color="red">
</hr>
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Employee Id:</font>
</td>
<td><input type="text" name="eid" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Name Of Employee:</font>
</td>
<td><input type="text" name="nemp" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Department:</font>
</td>
<td><input type="text" name="dept" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b> Salary:</font>
</td>
<td><input type="text" name="sal" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b> Contact Number:</font>
</td>
<td><input type="text" name="contact" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Address:</font>
</td>
<td><textarea wrap="virtual" name="add" rows=4 cols=16 maxlength=100></textarea>
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Date Of Joining:</font>
</td>
<td><select name="jday"><option>01
<option>02
<option>03
<option>04
<option>05
...
</select><select name="jmon"><option>jan
...
<option>oct
<option>nov
<option>dec</select><select name="jyear"><option>1990
<option>1991
<option>1992
<option>1993
<option>1994
...
<tr>
<td align="right"><input type="submit" value="add" name="add"></font>
</td>
<td><input type="reset" value="cancel" name="cancel">
</td></tr>
<tr>
<td align="center"><a href="admin.htm">back</a>
</td>
</tr>
</table>
</form>
