...
<form method="post" action="/registration">
   ...
   <tr bgcolor="#45d638">
   <td  ALIGN="CENTER"><font face="georgia" size="5" color="#f8h5d2"><b><h1>NEW USER CREATION PAGE</h1></font>
</td>
</tr>
<tr>
   <td><marquee behaviour="scroll" scrollamount="2"><font face="script mt bold" size="5" color="#226485">welcome to new user creation page</font></marquee>
</td>
</tr>
</table>
...
<td align="center" colspan="2"><font face="forte" size="5" color="red"><b><h1>NEW USER CREATION</h1></font>
</td>
</tr>
<tr>
...
<tr>
<td align="center"><font face="garamond" size="5" color="#h7d465"><b>User Name:</font>
</td>
<td><input type="text" name="user" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#h7d465"><b>Password :</font>
</td>
<td><input type="password" name="pass1" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#h7d465"><b> confirm Password :</font>
</td>
...
<tr>
<td align="center"><font face="garamond" size="5" color="#h7d465"><b>hint question:</font>
</td>
<td><select name="hint"><option>what is your mother name</option>
<option>what is your first teacher name </option>
</select>
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#h7d465"><b>user type:</font>
</td>
<td><select name="role"><option>administrator</option>
<option>user</option>
</select>
</td>
</tr>
...
<tr>
<td align="right"><input type="submit" value="submit" name="login"></font>
</td>
