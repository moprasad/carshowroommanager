...
<td valign="top">
   ...
   <tr>
   <td valign="top">
   <form method="post" action="/deliveryupdate"><table border="0" width="600"  cellspacing="0" cellpadding="2" align="center">
<tr>
<td align="center" colspan="2"><br><br><br><font face="forte" size="5" color="red"><b>DELIVERY DETAIL</font>
</td>
</tr>
<tr>
...
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Customer Id:</font>
</td>
<td><input type="text" name="cid" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Vehicle Id:</font>
</td>
<td><input type="text" name="vid" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Date Of Delivery:</font>
</td>
<td><select name="day"><option>01
<option>02
<option>03
<option>04
<option>05
...
</select><select name="mon"><option>jan
...
<option>oct
<option>nov
<option>dec</select><select name="year"><option>1990
<option>1991
<option>1992
<option>1993
<option>1994
...
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Bill Number:</font>
</td>
<td><input type="text" name="bill" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Pay Amount:</font>
</td>
<td><input type="text" name="payamt" size="20">
</td>
</tr>
<tr>
<td align="center"><font face="garamond" size="5" color="#ffffff"><b>Total Amount:</font>
</td>
<td><input type="text" name="tamt" size="20">
</td>
</tr>
