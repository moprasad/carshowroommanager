...
<td valign="top"><table border="1" cellpadding="0" cellspacing="0" width="765" height="675" bgcolor="#d4d4d4"><tr><td valign="top">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      <tr>
        <td width="100%">
        <p align="center"><b><font color="#800080" size="4"><%="Salary Entry Inforamtion"%></font></b></td>
      </tr>
      <tr>
        <td width="100%">
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#800080" width="100%" id="AutoNumber3">
          ...
          <tr>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#333399" width="100%" id="AutoNumber4">
              <tr>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">eid </font></b></td>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">month</font></b></td>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">year </font></b></td>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">amount</font></b></td>
<td width="20%"><b><font color="#008000" size="1" face="Verdana">sdate</font></b></td>
                </tr>
            </table>
            <%
	try{
		...
		if(rs!=null)
		{
			...
			<tr> 
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("eid")%></font></td>
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("month")%></font></td>
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("year")%></font></td>
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("amount")%></font></td>
<td width="20%"><font face="Verdana" size="1"><%=rs.getString("sdate")%></font></td>
