...
<td valign="top"><table border="1" cellpadding="0" cellspacing="0" width="765" height="675" bgcolor="#d4d4d4"><tr><td valign="top">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      <tr>
        <td width="100%">
        <p align="center"><b><font color="#800080" size="4"><%="Employee Entry Inforamtion"%></font></b></td>
      </tr>
      <tr>
        <td width="100%">
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#800080" width="100%" id="AutoNumber3">
          ...
          <tr>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#333399" width="100%" id="AutoNumber4">
              <tr>
                <td width="14%"><b><font color="#008000" size="1" face="Verdana">emp_id</font></b></td>
                <td width="14%"><b><font color="#008000" size="1" face="Verdana">name </font></b></td>
                <td width="14%"><b><font color="#008000" size="1" face="Verdana">dept</font></b></td>
                <td width="14%"><b><font color="#008000" size="1" face="Verdana">sal</font></b></td>
<td width="14%"><b><font color="#008000" size="1" face="Verdana">contact.no </font></b></td>
<td width="14%"><b><font color="#008000" size="1" face="Verdana">address</font></b></td>
<td width="14%"><b><font color="#008000" size="1" face="Verdana">doj</font></b></td>
                </tr>
            </table>
            <%
	try{
		...
		if(rs!=null)
		{
			...
			<tr> 
				<td width="14%"><font face="Verdana" size="1"><%=rs.getString("emp_id")%></font></td>
				<td width="14%"><font face="Verdana" size="1"><%=rs.getString("name")%></font></td>
				<td width="14%"><font face="Verdana" size="1"><%=rs.getString("dept")%></font></td>
				<td width="14%"><font face="Verdana" size="1"><%=rs.getString("sal")%></font></td>
<td width="14%"><font face="Verdana" size="1"><%=rs.getString("con_no")%></font></td>
<td width="14%"><font face="Verdana" size="1"><%=rs.getString("address")%></font></td>
<td width="14%"><font face="Verdana" size="1"><%=rs.getString("doj")%></font></td>
