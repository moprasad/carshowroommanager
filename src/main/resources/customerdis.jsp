...
<td valign="top"><table border="1" cellpadding="0" cellspacing="0" width="765" height="675" bgcolor="#d4d4d4"><tr><td valign="top">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
      <tr>
        <td width="100%">
        <p align="center"><b><font color="#800080" size="4"><%="Customer Entry Inforamtion"%></font></b></td>
      </tr>
      <tr>
        <td width="100%">
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#800080" width="100%" id="AutoNumber3">
          ...
          <tr>
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#333399" width="100%" id="AutoNumber4">
              <tr>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">cust_id</font></b></td>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">name </font></b></td>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">phoneno</font></b></td>
                <td width="20%"><b><font color="#008000" size="1" face="Verdana">address</font></b></td>
<td width="20%"><b><font color="#008000" size="1" face="Verdana">occupation </font></b></td>
                </tr>
            </table>
            <%
	try{
		...
		if(rs!=null)
		{
			...
			<tr> 
				...
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("name")%></font></td>
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("phoneno")%></font></td>
				<td width="20%"><font face="Verdana" size="1"><%=rs.getString("address")%></font></td>
<td width="20%"><font face="Verdana" size="1"><%=rs.getString("occupation")%></font></td>
